...
public class Week2day1program {
	...
	driver.findElement(By.id("createLeadForm_lastNameLocal")).sendKeys("user");
	
	driver.findElement(By.id("createLeadForm_personalTitle")).sendKeys("testdonot");
	
	driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("01/02/1994");
	
	driver.findElement(By.id("createLeadForm_generalProfTitle")).sendKeys("fun panrom");
	...
	driver.findElement(By.id("createLeadForm_sicCode")).sendKeys("600063");
	...
	driver.findElement(By.id("createLeadForm_primaryPhoneNumber")).sendKeys("7845941601");
	...
	driver.findElement(By.id("createLeadForm_generalCity")).sendKeys("texas");
